...
if block.CurrentTime > block.Dwork(3).Data + 0.5 * p.Ts
    ...
    block.Dwork(2).Data = [y.omega_m; y.omega_rpm; y.id; y.iq; y.id_ref; y.iq_ref; ...
        y.Pin; y.Pout; y.eta; y.g_hat; y.id_bar; y.steady_flag; ...
        y.optimizer_enable; y.freeze_state; y.projection_active; ...
        y.current_saturated; y.voltage_saturated; y.Te; y.us; y.is];
